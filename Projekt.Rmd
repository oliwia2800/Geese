...
Na zakończenie analizy opisowej stworzono wykres skrzypcowy, w którym porównano kwoty kredytów w zależności od faktu posiadania nieruchomości. Mediana kwoty kredytu jest identyczna w obu grupach, co sugeruje brak istotnej różnicy. Osoby nieposiadające nieruchomości wykazują większą zmienność kredytów. Choć różnica jest statystycznie istotna (p = 0,000339), efekt jest niewielki (r_biserial = 0,09).
