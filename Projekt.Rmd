...
Oś pozioma (X) przedstawia kategorię: N (Nie posiada nieruchomości) i Y (Posiada nieruchomość).
Oś pionowa (Y) reprezentuje kwotę kredytu, gdzie kolory reprezentują dwie grupy:
czerwony (osoby nieposiadające nieruchomości),
niebieski (osoby posiadające nieruchomość). \
