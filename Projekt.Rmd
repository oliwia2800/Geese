...
Druga postawiona hipoteza związana jest ze sprawdzeniem, czy istnieje zależność między przedziałem kwot kredytu a statusem rodzinnym. Chcemy zobaczyć jak np. małżeństwa czy osoby samotne różnią się pod względem wielkości kredytów, które biorą. Zdecydowano się na wizualizację kołową.
...
- H₁: Istnieje zależność między przedziałem kwoty kredytu a statusem rodzinnym. Rozkład wielkości kredytów różni się w zależności od statusu rodziny.
...
Na wykresie podano wyniki testu chi-kwadrat dla każdej grupy.\
