...
Zdecydowano się również na znalezienie zmiennych oraz ich nazw w naszym zbiorze danych, które powodują problemy ze skośnością.
...
Najniższy kredyt w grupie posiadającej problemy ze spłatą wynosi 11,53156, a najwyższy 14,92102. W grupie osób bezproblemowo spłacających kredyt minimalną wartością udzielonego kredytu jest 10,77835, a maksymalną 14,73870.
...
```{r, }
mod <- aov(TARGET ~ OCCUPATION_TYPE * NAME_HOUSING_TYPE,
           data = Data_hotdeck)
```
...
Typ zawodu (OCCUPATION_TYPE) ma istotny wpływ na to, czy klient ma problemy ze spłatą kredytu, ponieważ wartość p-value jest bardzo mała (0,0000959), odrzucamy hipotezę zerową. Sytuacja mieszkaniowa (NAME_HOUSING_TYPE) również ma istotny wpływ na problemy ze spłatą kredytu, z wartością p-value wynoszącą 0,00233, również odrzucamy w takim wypadku hipotezę zerową.\
