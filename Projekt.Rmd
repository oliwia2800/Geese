...
Dla każdej grupy p-value < 0.05, co oznacza, że odrzucamy hipotezę zerową. Istnieje istotny statystycznie związek między przedziałem kwoty kredytu, a statusem rodzinnym. Współczynnik V Craméra (0.08), wskazuje na słaby, ale istotny związek między zmiennymi.\
Analizując otrzymane wykresy można zauważyć kilka istotnych wniosków.\
W większości grup statusu rodzinnego, kredyty w średnim przedziale (12.43542 - 13.26395) stanowią największy udział. W grupie ozaczone jako "Wdowy", 45% osób korzysta z tego przedziału kredytowego, a w grupie „Single / not married” jest to 43%.\
